...
#  define je_aligned_alloc jaligned_alloc
#  define je_calloc jcalloc
#  define je_dallocx jdallocx
#  define je_free jfree
#  define je_mallctl jmallctl
#  define je_mallctlbymib jmallctlbymib
#  define je_mallctlnametomib jmallctlnametomib
#  define je_malloc jmalloc
#  define je_malloc_conf jmalloc_conf
#  define je_malloc_message jmalloc_message
#  define je_malloc_stats_print jmalloc_stats_print
#  define je_malloc_usable_size jmalloc_usable_size
#  define je_mallocx jmallocx
#  define je_nallocx jnallocx
#  define je_posix_memalign jposix_memalign
#  define je_rallocx jrallocx
#  define je_realloc jrealloc
#  define je_sallocx jsallocx
#  define je_sdallocx jsdallocx
#  define je_xallocx jxallocx
#  define je_valloc jvalloc
#endif
